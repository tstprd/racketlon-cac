...
function generateInProgressAnalysis(result, playerA, playerB, scores) {
  ...
  if (sportsRemaining === 1) {
    ...
    // 2+ sports remaining
    analyzeMultipleSportsRemaining(result, playerA, playerB, currentDelta, nextLabel, sportsRemaining);
  }
}
